...
/*
 *Created by LiHuan at 16:08 on 2019/4/4
 */
 class MakeUtils {
    ...
    private static final String XML_NAME = "dimens.xml";
     ...
     static float px2dip(float pxValue, int sw, int designWidth) {
     ...
     */
     static void makeAll(int designWidth, DimenTypes type, String buildDir) {
        try {
            //生成规则
